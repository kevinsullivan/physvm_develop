...
/*
Test 6.2 - Scalar Minus Scalar


Description - This object defines several scalars in the same space
 and attempts to subtract them, which is successful and
...
int main(int argc, char **argv){
    ...
    //4 : @@EuclideanGeometry3Scalar sminuss = EuclideanGeometry3Scalar(worldGeometry,Value=-1)
