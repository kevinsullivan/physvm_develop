...
/*
Test 5.7 - Assigning Vector to Point - Failure


Description - This test defines a vector and a point, and 
  then attempts to assign the vector to the variable previously
  designated as a Point, which triggers a failure.
