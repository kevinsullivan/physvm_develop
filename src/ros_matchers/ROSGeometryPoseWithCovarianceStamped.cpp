...
void ROSGeometryPoseWithCovarianceStamped::setup(){
...
void ROSGeometryPoseWithCovarianceStamped::run(const MatchFinder::MatchResult &Result){
    ...
    if(cxxConstructExpr_){
        ...
        {
            ROSGeometryPoseWithCovarianceStamped pm{context_, interp_};
            pm.setup();
	...
	arg_decay_exist_predicates["callExpr_geometry_msgs::PoseWithCovarianceStamped"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::PoseWithCovarianceStamped" or typenm =="geometry_msgs::PoseWithCovarianceStamped" or typenm == "const geometry_msgs::PoseWithCovarianceStamped" or typenm == "class geometry_msgs::PoseWithCovarianceStamped" or typenm == "const class geometry_msgs::PoseWithCovarianceStamped" or typenm ==  "::geometry_msgs::PoseWithCovarianceStamped_<allocator<void> >" or typenm == "operatorPoseWithCovarianceStamped" or typenm =="PoseWithCovarianceStamped" or typenm == "const PoseWithCovarianceStamped" or typenm == "class PoseWithCovarianceStamped" or typenm == "const class PoseWithCovarianceStamped" or typenm ==  "::PoseWithCovarianceStamped_<allocator<void> >"){ return true; }
    else { return false; }
    };
    if(callExpr_){
	...
	arg_decay_exist_predicates["memberExpr_geometry_msgs::PoseWithCovarianceStamped"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::PoseWithCovarianceStamped" or typenm =="geometry_msgs::PoseWithCovarianceStamped" or typenm == "const geometry_msgs::PoseWithCovarianceStamped" or typenm == "class geometry_msgs::PoseWithCovarianceStamped" or typenm == "const class geometry_msgs::PoseWithCovarianceStamped" or typenm ==  "::geometry_msgs::PoseWithCovarianceStamped_<allocator<void> >" or typenm == "operatorPoseWithCovarianceStamped" or typenm =="PoseWithCovarianceStamped" or typenm == "const PoseWithCovarianceStamped" or typenm == "class PoseWithCovarianceStamped" or typenm == "const class PoseWithCovarianceStamped" or typenm ==  "::PoseWithCovarianceStamped_<allocator<void> >"){ return true; }
    else { return false; }
    };
    if(memberExpr_){
        ...
        if(false){}
            ...
            ROSGeometryPoseWithCovarianceStamped innerm{this->context_,this->interp_};
            innerm.setup();
            innerm.visit(*inner);
	...
	arg_decay_exist_predicates["implicitCastExpr_geometry_msgs::PoseWithCovarianceStamped"] = [=](std::string typenm){
        if(false){return false; }
		else if(typenm == "operatorgeometry_msgs::PoseWithCovarianceStamped" or typenm =="geometry_msgs::PoseWithCovarianceStamped" or typenm == "const geometry_msgs::PoseWithCovarianceStamped" or typenm == "class geometry_msgs::PoseWithCovarianceStamped" or typenm == "const class geometry_msgs::PoseWithCovarianceStamped" or typenm ==  "::geometry_msgs::PoseWithCovarianceStamped_<allocator<void> >" or typenm == "operatorPoseWithCovarianceStamped" or typenm =="PoseWithCovarianceStamped" or typenm == "const PoseWithCovarianceStamped" or typenm == "class PoseWithCovarianceStamped" or typenm == "const class PoseWithCovarianceStamped" or typenm ==  "::PoseWithCovarianceStamped_<allocator<void> >"){ return true; }
        else { return false; } 
    };
	...
	arg_decay_exist_predicates["cxxBindTemporaryExpr_geometry_msgs::PoseWithCovarianceStamped"] = [=](std::string typenm){
        if(false){ return false; }
		else if(typenm == "operatorgeometry_msgs::PoseWithCovarianceStamped" or typenm =="geometry_msgs::PoseWithCovarianceStamped" or typenm == "const geometry_msgs::PoseWithCovarianceStamped" or typenm == "class geometry_msgs::PoseWithCovarianceStamped" or typenm == "const class geometry_msgs::PoseWithCovarianceStamped" or typenm ==  "::geometry_msgs::PoseWithCovarianceStamped_<allocator<void> >" or typenm == "operatorPoseWithCovarianceStamped" or typenm =="PoseWithCovarianceStamped" or typenm == "const PoseWithCovarianceStamped" or typenm == "class PoseWithCovarianceStamped" or typenm == "const class PoseWithCovarianceStamped" or typenm ==  "::PoseWithCovarianceStamped_<allocator<void> >"){ return true; }
        else { return false; }
    };
    ...
    {
        ROSGeometryPoseWithCovarianceStamped exprMatcher{ context_, interp_};
        exprMatcher.setup();
	...
	arg_decay_exist_predicates["materializeTemporaryExpr_geometry_msgs::PoseWithCovarianceStamped"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::PoseWithCovarianceStamped" or typenm =="geometry_msgs::PoseWithCovarianceStamped" or typenm == "const geometry_msgs::PoseWithCovarianceStamped" or typenm == "class geometry_msgs::PoseWithCovarianceStamped" or typenm == "const class geometry_msgs::PoseWithCovarianceStamped" or typenm ==  "::geometry_msgs::PoseWithCovarianceStamped_<allocator<void> >" or typenm == "operatorPoseWithCovarianceStamped" or typenm =="PoseWithCovarianceStamped" or typenm == "const PoseWithCovarianceStamped" or typenm == "class PoseWithCovarianceStamped" or typenm == "const class PoseWithCovarianceStamped" or typenm ==  "::PoseWithCovarianceStamped_<allocator<void> >"){ return true; }
        else { return false; }
    };
	...
	arg_decay_exist_predicates["parenExpr_geometry_msgs::PoseWithCovarianceStamped"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::PoseWithCovarianceStamped" or typenm =="geometry_msgs::PoseWithCovarianceStamped" or typenm == "const geometry_msgs::PoseWithCovarianceStamped" or typenm == "class geometry_msgs::PoseWithCovarianceStamped" or typenm == "const class geometry_msgs::PoseWithCovarianceStamped" or typenm ==  "::geometry_msgs::PoseWithCovarianceStamped_<allocator<void> >" or typenm == "operatorPoseWithCovarianceStamped" or typenm =="PoseWithCovarianceStamped" or typenm == "const PoseWithCovarianceStamped" or typenm == "class PoseWithCovarianceStamped" or typenm == "const class PoseWithCovarianceStamped" or typenm ==  "::PoseWithCovarianceStamped_<allocator<void> >"){ return true; }
        else { return false; } 
    };
    if (parenExpr_)
    {
        ROSGeometryPoseWithCovarianceStamped inner{ context_, interp_};
        inner.setup();
    ...
    if (cxxOperatorCallExpr_){
        ...
        if(auto dc = clang::dyn_cast<clang::NamedDecl>(decl_)){
            ...
            if(name == "operator="){
                ...
                ROSGeometryPoseWithCovarianceStamped rhsMatcher{ context_, interp_};
                rhsMatcher.setup();
