...
void ROSGeometryMsgsVector3StampedMatcher::setup(){
...
void ROSGeometryMsgsVector3StampedMatcher::run(const MatchFinder::MatchResult &Result){
    ...
    if(cxxConstructExpr_){
        ...
        {
            ROSGeometryMsgsVector3StampedMatcher pm{context_, interp_};
            pm.setup();
	...
	arg_decay_exist_predicates["memberExpr_geometry_msgs::Vector3Stamped"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm=="geometry_msgs::Vector3Stamped" or typenm == "const geometry_msgs::Vector3Stamped" or typenm == "class geometry_msgs::Vector3Stamped"/*typenm.find("geometry_msgs::Vector3Stamped") != string::npos*/){ return true; }
    else { return false; }
    };
    if(memberExpr_){
        ...
        if(false){}
        else if(typestr=="geometry_msgs::Vector3Stamped" or typestr == "const geometry_msgs::Vector3Stamped" or typestr == "const geometry_msgs::Vector3Stamped"/*typestr.find("geometry_msgs::Vector3Stamped") != string::npos*/){
            ROSGeometryMsgsVector3StampedMatcher innerm{this->context_,this->interp_};
            innerm.setup();
            innerm.visit(*inner);
	...
	arg_decay_exist_predicates["implicitCastExpr_geometry_msgs::Vector3Stamped"] = [=](std::string typenm){
        if(false){return false; }
		else if(typenm=="geometry_msgs::Vector3Stamped" or typenm == "const geometry_msgs::Vector3Stamped" or typenm == "class geometry_msgs::Vector3Stamped"/*typenm.find("geometry_msgs::Vector3Stamped") != string::npos*/){ return true; }
        else { return false; } 
    };
	...
	arg_decay_exist_predicates["cxxBindTemporaryExpr_geometry_msgs::Vector3Stamped"] = [=](std::string typenm){
        if(false){ return false; }
		else if(typenm=="geometry_msgs::Vector3Stamped" or typenm == "const geometry_msgs::Vector3Stamped" or typenm == "class geometry_msgs::Vector3Stamped"/*typenm.find("geometry_msgs::Vector3Stamped") != string::npos*/){ return true; }
        else { return false; }
    };
    ...
    {
        ROSGeometryMsgsVector3StampedMatcher exprMatcher{ context_, interp_};
        exprMatcher.setup();
	...
	arg_decay_exist_predicates["materializeTemporaryExpr_geometry_msgs::Vector3Stamped"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm=="geometry_msgs::Vector3Stamped" or typenm == "const geometry_msgs::Vector3Stamped" or typenm == "class geometry_msgs::Vector3Stamped"/*typenm.find("geometry_msgs::Vector3Stamped") != string::npos*/){ return true; }
        else { return false; }
    };
	...
	arg_decay_exist_predicates["parenExpr_geometry_msgs::Vector3Stamped"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm=="geometry_msgs::Vector3Stamped" or typenm == "const geometry_msgs::Vector3Stamped" or typenm == "class geometry_msgs::Vector3Stamped"/*typenm.find("geometry_msgs::Vector3Stamped") != string::npos*/){ return true; }
        else { return false; } 
    };
    if (parenExpr_)
    {
        ROSGeometryMsgsVector3StampedMatcher inner{ context_, interp_};
        inner.setup();
