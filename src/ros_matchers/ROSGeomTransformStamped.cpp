...
void ROSGeomTransformStamped::setup(){
...
void ROSGeomTransformStamped::run(const MatchFinder::MatchResult &Result){
    ...
    if(cxxConstructExpr_){
        ...
        {
            ROSGeomTransformStamped pm{context_, interp_};
            pm.setup();
	...
	arg_decay_exist_predicates["callExpr_geometry_msgs::TransformStamped"] = [=](std::string typenm){
	...
	arg_decay_exist_predicates["memberExpr_geometry_msgs::TransformStamped"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::TransformStamped" or typenm =="geometry_msgs::TransformStamped" or typenm == "const geometry_msgs::TransformStamped" or typenm == "class geometry_msgs::TransformStamped" or typenm == "const class geometry_msgs::TransformStamped" or typenm ==  "::geometry_msgs::TransformStamped_<allocator<void> >" or typenm == "operatorTransformStamped" or typenm =="TransformStamped" or typenm == "const TransformStamped" or typenm == "class TransformStamped" or typenm == "const class TransformStamped" or typenm ==  "::TransformStamped_<allocator<void> >"){ return true; }
    else { return false; }
    };
    if(memberExpr_){
        ...
        if(false){}
            ...
            ROSGeomTransformStamped innerm{this->context_,this->interp_};
            innerm.setup();
            innerm.visit(*inner);
	...
	arg_decay_exist_predicates["implicitCastExpr_geometry_msgs::TransformStamped"] = [=](std::string typenm){
        if(false){return false; }
		else if(typenm == "operatorgeometry_msgs::TransformStamped" or typenm =="geometry_msgs::TransformStamped" or typenm == "const geometry_msgs::TransformStamped" or typenm == "class geometry_msgs::TransformStamped" or typenm == "const class geometry_msgs::TransformStamped" or typenm ==  "::geometry_msgs::TransformStamped_<allocator<void> >" or typenm == "operatorTransformStamped" or typenm =="TransformStamped" or typenm == "const TransformStamped" or typenm == "class TransformStamped" or typenm == "const class TransformStamped" or typenm ==  "::TransformStamped_<allocator<void> >"){ return true; }
        else { return false; } 
    };
	...
	arg_decay_exist_predicates["cxxBindTemporaryExpr_geometry_msgs::TransformStamped"] = [=](std::string typenm){
        if(false){ return false; }
		else if(typenm == "operatorgeometry_msgs::TransformStamped" or typenm =="geometry_msgs::TransformStamped" or typenm == "const geometry_msgs::TransformStamped" or typenm == "class geometry_msgs::TransformStamped" or typenm == "const class geometry_msgs::TransformStamped" or typenm ==  "::geometry_msgs::TransformStamped_<allocator<void> >" or typenm == "operatorTransformStamped" or typenm =="TransformStamped" or typenm == "const TransformStamped" or typenm == "class TransformStamped" or typenm == "const class TransformStamped" or typenm ==  "::TransformStamped_<allocator<void> >"){ return true; }
        else { return false; }
    };
    ...
    {
        ROSGeomTransformStamped exprMatcher{ context_, interp_};
        exprMatcher.setup();
	...
	arg_decay_exist_predicates["materializeTemporaryExpr_geometry_msgs::TransformStamped"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::TransformStamped" or typenm =="geometry_msgs::TransformStamped" or typenm == "const geometry_msgs::TransformStamped" or typenm == "class geometry_msgs::TransformStamped" or typenm == "const class geometry_msgs::TransformStamped" or typenm ==  "::geometry_msgs::TransformStamped_<allocator<void> >" or typenm == "operatorTransformStamped" or typenm =="TransformStamped" or typenm == "const TransformStamped" or typenm == "class TransformStamped" or typenm == "const class TransformStamped" or typenm ==  "::TransformStamped_<allocator<void> >"){ return true; }
        else { return false; }
    };
	...
	arg_decay_exist_predicates["parenExpr_geometry_msgs::TransformStamped"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm == "operatorgeometry_msgs::TransformStamped" or typenm =="geometry_msgs::TransformStamped" or typenm == "const geometry_msgs::TransformStamped" or typenm == "class geometry_msgs::TransformStamped" or typenm == "const class geometry_msgs::TransformStamped" or typenm ==  "::geometry_msgs::TransformStamped_<allocator<void> >" or typenm == "operatorTransformStamped" or typenm =="TransformStamped" or typenm == "const TransformStamped" or typenm == "class TransformStamped" or typenm == "const class TransformStamped" or typenm ==  "::TransformStamped_<allocator<void> >"){ return true; }
        else { return false; } 
    };
    if (parenExpr_)
    {
        ROSGeomTransformStamped inner{ context_, interp_};
        inner.setup();
    ...
    if (cxxOperatorCallExpr_){
        ...
        if(auto dc = clang::dyn_cast<clang::NamedDecl>(decl_)){
            ...
            if(name == "operator="){
                ...
                ROSGeomTransformStamped rhsMatcher{ context_, interp_};
                rhsMatcher.setup();
