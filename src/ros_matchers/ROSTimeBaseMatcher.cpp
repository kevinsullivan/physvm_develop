...
void ROSTimeBaseMatcher::run(const MatchFinder::MatchResult &Result){
    ...
    if(cxxConstructExpr_){
        ...
        {
            ROSTimeBaseMatcher pm{context_, interp_};
            pm.setup();
	...
	arg_decay_exist_predicates["callExpr_ros::TimeBase"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm == "operatorros::TimeBase" or typenm =="ros::TimeBase" or typenm == "const ros::TimeBase" or typenm == "class ros::TimeBase" or typenm == "const class ros::TimeBase" or typenm ==  "::ros::TimeBase_<allocator<void> >" or typenm == "operatorTimeBase" or typenm =="TimeBase" or typenm == "const TimeBase" or typenm == "class TimeBase" or typenm == "const class TimeBase" or typenm ==  "::TimeBase_<allocator<void> >"){ return true; }
		else if(typenm == "operatorros::Time" or typenm =="ros::Time" or typenm == "const ros::Time" or typenm == "class ros::Time" or typenm == "const class ros::Time" or typenm ==  "::ros::Time_<allocator<void> >" or typenm == "operatorTime" or typenm =="Time" or typenm == "const Time" or typenm == "class Time" or typenm == "const class Time" or typenm ==  "::Time_<allocator<void> >"){ return true; }
    else { return false; }
	...
	arg_decay_exist_predicates["memberExpr_ros::TimeBase"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm == "operatorros::TimeBase" or typenm =="ros::TimeBase" or typenm == "const ros::TimeBase" or typenm == "class ros::TimeBase" or typenm == "const class ros::TimeBase" or typenm ==  "::ros::TimeBase_<allocator<void> >" or typenm == "operatorTimeBase" or typenm =="TimeBase" or typenm == "const TimeBase" or typenm == "class TimeBase" or typenm == "const class TimeBase" or typenm ==  "::TimeBase_<allocator<void> >"){ return true; }
		else if(typenm == "operatorros::Time" or typenm =="ros::Time" or typenm == "const ros::Time" or typenm == "class ros::Time" or typenm == "const class ros::Time" or typenm ==  "::ros::Time_<allocator<void> >" or typenm == "operatorTime" or typenm =="Time" or typenm == "const Time" or typenm == "class Time" or typenm == "const class Time" or typenm ==  "::Time_<allocator<void> >"){ return true; }
    else { return false; }
    ...
    if(memberExpr_){
        ...
        if(false){}
            ...
            ROSTimeBaseMatcher innerm{this->context_,this->interp_};
            innerm.setup();
            innerm.visit(*inner);
            ...
            ROSTimeMatcher innerm{this->context_,this->interp_};
            innerm.setup();
            innerm.visit(*inner);
            this->childExprStore_ = (clang::Stmt*)innerm.getChildExprStore();
            return;
	...
	arg_decay_exist_predicates["implicitCastExpr_ros::TimeBase"] = [=](std::string typenm){
        if(false){return false; }
		else if(typenm == "operatorros::TimeBase" or typenm =="ros::TimeBase" or typenm == "const ros::TimeBase" or typenm == "class ros::TimeBase" or typenm == "const class ros::TimeBase" or typenm ==  "::ros::TimeBase_<allocator<void> >" or typenm == "operatorTimeBase" or typenm =="TimeBase" or typenm == "const TimeBase" or typenm == "class TimeBase" or typenm == "const class TimeBase" or typenm ==  "::TimeBase_<allocator<void> >"){ return true; }
		else if(typenm == "operatorros::Time" or typenm =="ros::Time" or typenm == "const ros::Time" or typenm == "class ros::Time" or typenm == "const class ros::Time" or typenm ==  "::ros::Time_<allocator<void> >" or typenm == "operatorTime" or typenm =="Time" or typenm == "const Time" or typenm == "class Time" or typenm == "const class Time" or typenm ==  "::Time_<allocator<void> >"){ return true; }
        else { return false; } 
	...
	arg_decay_exist_predicates["cxxBindTemporaryExpr_ros::TimeBase"] = [=](std::string typenm){
        if(false){ return false; }
		else if(typenm == "operatorros::TimeBase" or typenm =="ros::TimeBase" or typenm == "const ros::TimeBase" or typenm == "class ros::TimeBase" or typenm == "const class ros::TimeBase" or typenm ==  "::ros::TimeBase_<allocator<void> >" or typenm == "operatorTimeBase" or typenm =="TimeBase" or typenm == "const TimeBase" or typenm == "class TimeBase" or typenm == "const class TimeBase" or typenm ==  "::TimeBase_<allocator<void> >"){ return true; }
		else if(typenm == "operatorros::Time" or typenm =="ros::Time" or typenm == "const ros::Time" or typenm == "class ros::Time" or typenm == "const class ros::Time" or typenm ==  "::ros::Time_<allocator<void> >" or typenm == "operatorTime" or typenm =="Time" or typenm == "const Time" or typenm == "class Time" or typenm == "const class Time" or typenm ==  "::Time_<allocator<void> >"){ return true; }
        else { return false; }
    ...
    {
        ROSTimeBaseMatcher exprMatcher{ context_, interp_};
        exprMatcher.setup();
	...
	arg_decay_exist_predicates["materializeTemporaryExpr_ros::TimeBase"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm == "operatorros::TimeBase" or typenm =="ros::TimeBase" or typenm == "const ros::TimeBase" or typenm == "class ros::TimeBase" or typenm == "const class ros::TimeBase" or typenm ==  "::ros::TimeBase_<allocator<void> >" or typenm == "operatorTimeBase" or typenm =="TimeBase" or typenm == "const TimeBase" or typenm == "class TimeBase" or typenm == "const class TimeBase" or typenm ==  "::TimeBase_<allocator<void> >"){ return true; }
		else if(typenm == "operatorros::Time" or typenm =="ros::Time" or typenm == "const ros::Time" or typenm == "class ros::Time" or typenm == "const class ros::Time" or typenm ==  "::ros::Time_<allocator<void> >" or typenm == "operatorTime" or typenm =="Time" or typenm == "const Time" or typenm == "class Time" or typenm == "const class Time" or typenm ==  "::Time_<allocator<void> >"){ return true; }
        else { return false; }
	...
	arg_decay_exist_predicates["parenExpr_ros::TimeBase"] = [=](std::string typenm){
        if(false){return false;}
		else if(typenm == "operatorros::TimeBase" or typenm =="ros::TimeBase" or typenm == "const ros::TimeBase" or typenm == "class ros::TimeBase" or typenm == "const class ros::TimeBase" or typenm ==  "::ros::TimeBase_<allocator<void> >" or typenm == "operatorTimeBase" or typenm =="TimeBase" or typenm == "const TimeBase" or typenm == "class TimeBase" or typenm == "const class TimeBase" or typenm ==  "::TimeBase_<allocator<void> >"){ return true; }
		else if(typenm == "operatorros::Time" or typenm =="ros::Time" or typenm == "const ros::Time" or typenm == "class ros::Time" or typenm == "const class ros::Time" or typenm ==  "::ros::Time_<allocator<void> >" or typenm == "operatorTime" or typenm =="Time" or typenm == "const Time" or typenm == "class Time" or typenm == "const class Time" or typenm ==  "::Time_<allocator<void> >"){ return true; }
        else { return false; } 
    ...
    if (parenExpr_)
    {
        ROSTimeBaseMatcher inner{ context_, interp_};
        inner.setup();
    ...
    if (cxxOperatorCallExpr_){
        ...
        if(auto dc = clang::dyn_cast<clang::NamedDecl>(decl_)){
            ...
            if(name == "operator="){
                ...
                ROSTimeBaseMatcher rhsMatcher{ context_, interp_};
                rhsMatcher.setup();
    ...
    if(callExpr_){
        ...
        if(auto dc = clang::dyn_cast<clang::NamedDecl>(decl_)){
            ...
            if((name == "operatornow" or name =="now" or name == "const now" or name == "class now" or name == "const class now" or name ==  "::now_<allocator<void> >")){            
                if (true ){
                    if(true ){
                        //interp_->mk(callExpr_);
                        
                        interp_->mkNode("LIT_R1",callExpr_,true);
                        this->childExprStore_ = (clang::Stmt*)callExpr_;
                        return;
                    }
