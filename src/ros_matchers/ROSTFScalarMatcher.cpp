...
void ROSTFScalarMatcher::run(const MatchFinder::MatchResult &Result){
	...
	arg_decay_exist_predicates["BinaryOperator(tfScalar?FORCE,tfScalar?FORCE).+@$.ADDtfScalar"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm=="tfScalar" or typenm == "const tfScalar" or typenm == "class tfScalar" or typenm == "const class tfScalar"){ return true; }
    else { return false; }
    };
	...
	arg_decay_exist_predicates["BinaryOperator(tfScalar?FORCE,tfScalar?FORCE).*@$.MULtfScalar"] = [=](std::string typenm){
    if(false){return false;}
		else if(typenm=="tfScalar" or typenm == "const tfScalar" or typenm == "class tfScalar" or typenm == "const class tfScalar"){ return true; }
    else { return false; }
    };
