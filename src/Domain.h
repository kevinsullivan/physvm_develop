...
public:
    VecLitExpr(Space& s, const coords::VectorLit* ast) : Expr(s, ast) { }
...
class Binding {
public:
	Binding(const coords::Binding* ast_wrapper, const domain::Identifier* identifier, const domain::Expr* expr):
