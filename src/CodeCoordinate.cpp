...
void VectorASTNode::setASTNode(const clang::CXXConstructExpr *vecInstStmt, const MatchFinder::MatchResult &vecInstResult)
{
...
void VectorASTNode::setASTNodeFilePath(const clang::CXXConstructExpr *_vecInstStmt, const MatchFinder::MatchResult &_ref_result)
{
