...
variables (K : Type u) [field K] [inhabited K] {f : fm K} {sp : spc K f} {f1 : fm K} {f2 : fm K}
-- {K : Type u} [field K] [inhabited K] {f : fm K}
structure duration_var {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f) extends var 

inductive duration_expr {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f) : Type u
| lit (v : duration sp) : duration_expr
| var (v : duration_var sp) : duration_expr

abbreviation duration_env {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f) := 
  duration_var sp → duration sp

abbreviation duration_eval {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f)  := 
  duration_env sp → duration_var sp → duration sp

structure time_var {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f) extends var

inductive time_expr {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f) : Type u
| lit (p : time sp) : time_expr
| var (v : time_var sp) : time_expr

abbreviation time_env {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f)  := 
  time_var sp → time sp

abbreviation time_eval {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f)  := 
  time_env sp → time_var sp → time sp

structure transform_var {K : Type u} [field K] [inhabited K] 
  {f1 : fm K} {f2 : fm K} (sp1 : spc K f1) (sp2 : spc K f2) extends var

inductive transform_expr {K : Type u} [field K] [inhabited K] 
  {f1 : fm K} {f2 : fm K} (sp1 : spc K f1) (sp2 : spc K f2) : Type u
...
abbreviation transform_env {K : Type u} [field K] [inhabited K] 
  {f1 : fm K} {f2 : fm K} (sp1 : spc K f1) (sp2 : spc K f2)  := 
...
structure env {K : Type u} [field K] [inhabited K] {f : fm K} (sp : spc K f) :=
  (d : duration_env sp )
  (t : time_env sp )
