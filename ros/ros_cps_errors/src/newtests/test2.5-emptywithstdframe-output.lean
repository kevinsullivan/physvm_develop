...
def worldGeometry.stdFrame := cmd.classicalGeometryFrameAssmt (lang.classicalGeometry.frame_var.mk 11) (lang.classicalGeometry.getStdFrame (classicalGeometryEval (lang.classicalGeometry.expr.var (lang.classicalGeometry.var.mk 1)) ( env8 )))
...
def INDEX104809424.STMTCOMMAND.B.L97C32.E.L110C1 : cmd :=(cmd.seq worldVelocity cmd.seq(worldVelocity.stdFrame (cmd.seq worldTime cmd.seq ( worldTime.stdFrame cmd.seq (worldGeometry worldGeometry.stdFrame)))))
