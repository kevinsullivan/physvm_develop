...
/*
Test 6.1 - Scalar Plus Scalar


Description - This object defines several scalars in the same space
 and attempts to add them together, which is successful and
 results in another scalar.
...
int main(int argc, char **argv){
    ...
    //4 : @@EuclideanGeometry3Scalar spluss = EuclideanGeometry3Scalar(worldGeometry,Value=3)
    tfScalar spluss = x + y;
}