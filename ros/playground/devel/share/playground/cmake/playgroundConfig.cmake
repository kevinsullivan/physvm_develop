...
if("TRUE" STREQUAL "TRUE")
  set(playground_SOURCE_PREFIX /peirce/ros/playground/src/playground)
  set(playground_DEVEL_PREFIX /peirce/ros/playground/devel)
  ...
  set(playground_INSTALL_PREFIX /peirce/ros/playground/install)
...
if(NOT "/peirce/ros/playground/src/playground/include " STREQUAL " ")
  set(playground_INCLUDE_DIRS "")
  set(_include_dirs "/peirce/ros/playground/src/playground/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'playground' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'playground' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/peirce/ros/playground/src/playground/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT playground_NUM_DUMMY_TARGETS)
      set(playground_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::playground::wrapped-linker-option${playground_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR playground_NUM_DUMMY_TARGETS "${playground_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::playground::wrapped-linker-option${playground_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND playground_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /peirce/ros/playground/devel/lib;/peirce/ros/playground/devel/lib;/opt/ros/melodic/lib)
...
set(playground_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${playground_dep}_FOUND)
      find_package(${playground_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${playground_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
